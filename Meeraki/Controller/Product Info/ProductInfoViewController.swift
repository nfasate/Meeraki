...
class ProductInfoViewController: UIViewController {
    ...
    func initializeGoogleMap() {
        if Macros.Variables.userCurrentLat != nil {
            self.addMapToView()
            return
        }else
        {
            Singleton.shared.delay(2.0, closure: {
                if Macros.Variables.userCurrentLat != nil {
                    ...
                    Macros.Variables.userCurrentLat = 21.1458004
                    Macros.Variables.userCurrentLong = 79.0881546
                    self.addMapToView()
                }
            })
        }
    ...
    func addMapToView()
    {
        if objGMVC == nil
        {
            ...
            objGMVC.currentLoc = CLLocationCoordinate2DMake(Macros.Variables.userCurrentLat, Macros.Variables.userCurrentLong)
...
//        }
    ...
    func mapViewMarkerTapped(_ mapView: GMSMapView, marker: GMSMarker)
    {
        ...
        {
            if myMarker.markerID != nil, (myMarker.markerID == 5 ||  myMarker.markerID == 6)
            {
