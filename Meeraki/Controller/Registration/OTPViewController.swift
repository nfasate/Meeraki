...
class OTPViewController: UIViewController {
    ...
    func setup() {
        ...
        lblInfo.text = "We have sent an OTP on your number \(mobileNumber ?? "")"
    ...
    func presentCreateProfileScreen() {
        ...
        regController.mobileNumber = mobileNumber
        Macros.Variables.targetController?.present(regController, animated: true, completion: nil)
    }
